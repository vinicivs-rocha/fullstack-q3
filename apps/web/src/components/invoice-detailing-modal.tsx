...
export const InvoiceDetailingModal = forwardRef<InvoiceDetailingModalRef, InvoiceDetailingModalProps>(({ 
  isOpen, 
  onClose, 
  invoice, 
  isLoading,
  ...
  useImperativeHandle(ref, () => ({
    ...
    waitForContent: async () => { 
      ...
      while (!mainContentRef.current || mainContentRef.current.children.length === 0) {
  ...
  if (isLoading) {
    return (
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent aria-describedby={`invoice-detailing-modal-${invoice?.id}`} className="min-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
  ...
  if (!invoice) {
    return (
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent aria-describedby={`invoice-detailing-modal-error`} className="min-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
        ...
        >
          <DialogHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <DialogDescription>
                  Informações completas da vistoria do veículo {invoice.vehicle.plate}
                </DialogDescription>
              </div>
              <Button
                onClick={onDownload}
          ...
          <div ref={mainContentRef} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                <h3 className="text-sm font-medium text-gray-500">Data da Vistoria</h3>
              ...
              <div className="space-y-2">
                <h3 className="text-sm font-medium text-gray-500">ID da Vistoria</h3>
            ...
            <div className="border rounded-lg p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm">{invoice.vehicle.brand} {invoice.vehicle.model}</p>
                </div>
                <div>
                ...
                {invoice.vehicle.mileage && (
                  <div>
                    ...
                    <p className="text-sm">{invoice.vehicle.mileage.toLocaleString('pt-BR')} km</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="border rounded-lg p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm">{invoice.surveyor.gender === 'M' ? 'Masculino' : 'Feminino'}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500">Licença</label>
                  <p className="text-sm font-mono bg-gray-50 px-2 py-1 rounded">
            ...
            <div className="border rounded-lg p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="text-sm font-medium text-gray-500">Valor da Vistoria</label>
